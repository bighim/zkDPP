...
등록 요청은 사용자를 Server와 Blockchain에 등록하기 위한 요청이다.
...
upstream에서 출발해 indirect downstream까지 전달된 공급망을
다시 upstream 방향으로 되돌리는 것은 어렵다고 보았다.
...
본 논문에서는 DPP를 제품의 생애주기 동안 갱신할 수 있는 동적 디지털 데이터 객체라 정의한다.  \\
...
Input과 output commitment의 관계를 직접 공개하는 별도 provenance event는 발행하지 않는다.\\
