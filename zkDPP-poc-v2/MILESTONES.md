...
| M1-HF | 완료 | terminal·Snapshot·측정·검증의 명세 일치 Hotfix | — | [명세](milestones/M1-HF-spec-conformance.md) | [Result](milestones/M1-HF-spec-conformance-result.md) |
...
M1은 당시 POC 기록으로 보존합니다. source review에서 확인한 명세 일치 문제는 [M1-HF](milestones/M1-HF-spec-conformance-result.md)에서 수정하고 실제 proof·Anvil·RPC 감사까지 검증했습니다. 실제 DKG와 key rotation은 각각 M2·M3의 별도 범위입니다.
